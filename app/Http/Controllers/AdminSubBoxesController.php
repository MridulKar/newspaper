<?php namespace App\Http\Controllers;
	...
	class AdminSubBoxesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "sub_boxes";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Division Name","name"=>"box_id","join"=>"boxes,title"];
			$this->col[] = ["label"=>"News URL","name"=>"slug"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Division Name','name'=>'box_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'boxes,title'];
			$this->form[] = ['label'=>'News URL','name'=>'slug','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Image','name'=>'image','type'=>'upload','width'=>'col-sm-10','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP','image'=>true];
			...
			$this->form[] = ['label'=>'Banner Image','name'=>'banner_image','type'=>'upload','width'=>'col-sm-10'];
			# END FORM DO NOT REMOVE THIS LINE

			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Box Id","name"=>"box_id","type"=>"select2","required"=>TRUE,"validation"=>"required|min:1|max:255","datatable"=>"box,id"];
