<?php namespace App\Http\Controllers;
	...
	class AdminSocialMediaController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Social Media","name"=>"title"];
			$this->col[] = ["label"=>"URL","name"=>"slug"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Social Media','name'=>'title','type'=>'text','validation'=>'required|string|min:3|max:70','width'=>'col-sm-10','placeholder'=>'You can only enter the letter only'];
			$this->form[] = ['label'=>'URL','name'=>'slug','type'=>'text','validation'=>'required|url','width'=>'col-sm-10'];
