<?php namespace App\Http\Controllers;
	...
	class AdminPostsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"News Category","name"=>"category_id","join"=>"categories,category_title"];
			$this->col[] = ["label"=>"URL in Small Letter","name"=>"slug"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'News Category','name'=>'category_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'categories,category_title'];
			$this->form[] = ['label'=>'URL in Small Letter','name'=>'slug','type'=>'text','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'Image','name'=>'image','type'=>'upload','width'=>'col-sm-10','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP'];
			//$this->form[] = ['label'=>'Title','name'=>'title','type'=>'text','validation'=>'required|string|min:3|max:70','width'=>'col-sm-10','placeholder'=>'You can only enter the letter only'];
			//$this->form[] = ['label'=>'Description','name'=>'description','type'=>'multitext','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Author','name'=>'author','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Date','name'=>'date','type'=>'date','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Banner Image','name'=>'banner_image','type'=>'upload','width'=>'col-sm-10'];
			# OLD END FORM
